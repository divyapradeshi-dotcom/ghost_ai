Clerk is already installed and connected . Wire it into the Next.js app: provider , auth pages,
...
- larges screen:simple two-panel layout
...
Add Clerk's built-in `UserButton` to the editor navbar right section for profile settings and 
layout.

Keep Clerk's default user menu and profile flows intact . Do not rebuild or heavily customize Clerk
internals.
...
- all route are protected except public auth paths
