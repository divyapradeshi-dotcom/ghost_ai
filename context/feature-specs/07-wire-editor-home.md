...
Fetch owned and shared projects server-side using the existing project data helper and pass both
lists to the sidebar.
...
- rename dialog pre-files current name
- delete dialog showns project name

### check when done

- sidebar uses real project date
